    ...
    def fire(self):    
        ...
        if self.timer == 50:
            ...
            if self.bullettype == 0:
                ...
                bullet = BulletSprite("images/bullet/bullet1.png", [self.rect.x + 30, self.rect.y - 20], 6)
                bullet2 = BulletSprite("images/bullet/bullet1.png", [self.rect.x + 60, self.rect.y - 20], 6)
                self.bulletgroup.add(bullet, bullet2)
            elif self.bullettype == 2:
                bullet = BulletSprite("images/bullet/bullet1.png", [self.rect.x + 30, self.rect.y - 20], 6)
                bullet2 = BulletSprite("images/bullet/bullet1.png", [self.rect.x + 60, self.rect.y - 20], 6)
                bullet3 = BulletSprite("images/bullet/bullet3r.png", [self.rect.x + 65, self.rect.y - 20], 6)
                bullet4 = BulletSprite("images/bullet/bullet3l.png", [self.rect.x + 25, self.rect.y - 20], 6)
                bullet5 = BulletSprite("images/bullet/bullet3r.png", [self.rect.x + 70, self.rect.y - 20], 6)
                bullet6 = BulletSprite("images/bullet/bullet3l.png", [self.rect.x + 25, self.rect.y - 20], 6)
...
class BulletSprite(pygame.sprite.Sprite): #传入父类，精灵                          
...
class BulletHelp(pygame.sprite.Sprite):   # 补给品
    ...
    def update(self):
        ...
        if self.rect.y > 800:
            self.kill()
        if self.rect.x < 0 or self.rect.x > 400:
             self.xspeed *= -1    

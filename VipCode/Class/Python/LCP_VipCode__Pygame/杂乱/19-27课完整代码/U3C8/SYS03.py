...
class Bird(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.images = []
        for i in range(3):
            img = pygame.image.load("./img/bird%s_%s.png" % ((app.index%3),i)).convert_alpha()
...
class APP():
    ...
    def selectBird(self):         # -------------------------
        """ 选鸟 """
        self.index += 1  # -------------------------
        self.rolelist[self.index%3][1].y = 370  # -------------------------
        self.rolelist[(self.index+1)%3][1].y = 400  # -------------------------
        self.rolelist[(self.index-1)%3][1].y = 400  # -------------------------
    ...
    def main(self):
        while True:
            ...
            if self.flag:
                ...
                self.screen.blit(self.font36.render('Please choose your role', True, (255, 255, 0)), (50, 260))

...
class Bird():
    def __init__(self):
        self.images = []
        for i in range(3):
            img = pygame.image.load(r"C:\CODE\P2_CLASS\Python\LCP_VipCode__Pygame\image\bird0_%s.png" % i).convert_alpha()
...
class APP():
    def __init__(self):
        ...
        self.bg = pygame.image.load(r"C:\CODE\P2_CLASS\Python\LCP_VipCode__Pygame\image\bg_day.png").convert()  # 背景图片导入并缩放为窗口大小
        self.bg = pygame.transform.smoothscale(self.bg, (self.width, self.height))
        self.FPSclock = pygame.time.Clock()
        self.pipe_down_image = pygame.image.load(r"C:\CODE\P2_CLASS\Python\LCP_VipCode__Pygame\image\pipe_down.png").convert_alpha()
        self.pipe_up_image = pygame.image.load(r"C:\CODE\P2_CLASS\Python\LCP_VipCode__Pygame\image\pipe_up.png").convert_alpha()

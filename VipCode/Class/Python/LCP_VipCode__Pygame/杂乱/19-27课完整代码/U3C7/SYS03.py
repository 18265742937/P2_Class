...
class APP():
    def __init__(self):
        ...
        self.score = 0
        pygame.time.set_timer(USEREVENT, 1500)    # 事件常量  时间--------------
        ...
        while True:
            ...
            for event in pygame.event.get():
                ...
                if event.type == USEREVENT:   # -----------------
                    y = random.randint(-120, 120)         #           mv
                    pipe_up = Pipe(self.pipe_up_image, 260 + 80 + y)          #         mv
                    pipe_down = Pipe(self.pipe_down_image, -60 - 80 + y)           #        mv
                    self.pipes.add(pipe_up, pipe_down)            #       mv

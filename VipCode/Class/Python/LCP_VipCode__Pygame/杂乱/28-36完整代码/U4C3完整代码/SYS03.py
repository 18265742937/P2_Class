...
class EnemySprite(pygame.sprite.Sprite):
    ...
    def __init__(self, image):
        ...
        self.image = pygame.image.load(image)
        self.rect = self.image.get_rect()
        self.rect.x = random.randint(0, 300)   #-- 随机x坐标
        self.rect.y = random.randint(0, 560)   #-- 随机x坐标
...
def main():
    ...
    enemy = EnemySprite("images/enemy/enemy2.png")  # -- 其他飞机
    ...
    while True:
        ...
        for event in pygame.event.get():
            if event.type == locals.QUIT:
                ...
                sys.exit()
        group_player.update()
        group_player.draw(screen)  # 对精灵组进行绘制

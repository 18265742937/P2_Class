...
class PlayerSprite(pygame.sprite.Sprite):  # 玩家战机
    ...
    def playMusic(self):
        ...
        music.load(r"C:\CODE\P2_CLASS\Python\LCP_VipCode__Pygame\杂乱\28-36完整代码\U4C8 完整代码\music\BGM3.flac")  # 加载音乐
        music.play(-1)  # 无限播放音乐
    ...
    def fire(self):  # --------
        bullet = BulletSprite(r"C:\CODE\P2_CLASS\Python\LCP_VipCode__Pygame\杂乱\28-36完整代码\U4C8 完整代码\images\bullet\bullet1.png", [self.rect.x + 45, self.rect.y - 20], 6)
...
def main():
    ...
    image_bg = pygame.image.load(r"C:\CODE\P2_CLASS\Python\LCP_VipCode__Pygame\杂乱\28-36完整代码\U4C8 完整代码\images\bg\bg1.jpg")
    image_bg = pygame.transform.smoothscale(image_bg, (500, 700))
    FPSclock = pygame.time.Clock()
    player = PlayerSprite(r"C:\CODE\P2_CLASS\Python\LCP_VipCode__Pygame\杂乱\28-36完整代码\U4C8 完整代码\images\hero\hero_b_03.png", screen)

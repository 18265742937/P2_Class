...
class Snake():
    ...
    def addButton(self, txt, pos):
        smallText = pygame.font.Font(
            r"D:\Code\P2_CLASS\LCP_VipCode_pygame\font\STXINGKA.TTF", 20)
    ...
    def fraction(self):
        """管理分数"""
        self.writeFont(r"D:\Code\P2_CLASS\LCP_VipCode_pygame\font\STXINGKA.TTF",
                       25, "分数:"+str(self.score), self.greyColor, 0, 0)
    ...
    def main(self):
        ...
        while True:
            ...
            if self.flag:
                ...
                self.addButton("继续游戏", self.btn1)
                self.addButton("退出游戏", self.btn2)

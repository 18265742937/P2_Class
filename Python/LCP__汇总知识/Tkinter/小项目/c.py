...
class start():
    def work(self):
        ...
        self.label = Label(window, text="考试准备", fg="blue",
                           bg="orange", font="SansSerif 30 bold")
        self.label.pack()
        # print(type(self.label))
        la = Label(window, text="准考证号", fg="green",
                   bg="orange", font="SansSerif 10 bold")
        la.pack()
        self.a = tk.Entry(window, show=None)
        self.a.pack()
        self.lab = Label(window, text="考生姓名", fg="green",
                         bg="orange", font="SansSerif 10 bold")
        self.lab.pack()
        self.b = tk.Entry(window, show=None)
        self.b.pack()
        lab_empty = Label(window, text="                ",
                          fg="green", bg="orange", font="SansSerif 10 bold")
        lab_empty.pack()
        bt = Button(window, text="确认考生信息", fg="green", bg="orange",
                    font="SansSerif 10 bold", command=self.right_click)
        bt.pack()
        window.mainloop()
...
# class answer_page(start):
    def start_answer(self):
        ...
        self.answers = ["状态变化的方式", "b/s", "103", "光学的", "存储",
                        "-3", "28/31", "-1", "0.5", "惯性定律"]  # --------答案
        self.time = 0
        self.marks = 0  # 计分器
        self.page = tk.Tk()
        ...
        self.Qe = tk.Label(self.page, textvariable=self.var,
                           fg="blue", bg="orange", font="SansSerif 15 bold")
        ...
        self.c.pack()
        self.btn = Button(self.page, textvariable=self.v, fg="green",
                          bg="orange", font="SansSerif 10 bold", command=self.next_click)
        self.v.set("下一题")
        self.btn.pack()
        self.page.mainloop()
